                                ...
                                if (!handled) {
                                    ...
                                    if (initiatorShift != null) {
                                        ...
                                        val cafeId = initiatorShift.optString("cafeNumber")
                                         ...
                                         val rawWorkstationName = initiatorShift.optString("workstationName")
                                         val workstationId = initiatorShift.optString("workstationId")
                                         val workstationCode = initiatorShift.optString("workstationCode")
                                         val lookupKey = if (workstationId.isNotEmpty()) workstationId 
                                                         else if (workstationCode.isNotEmpty()) workstationCode 
                                                         else rawWorkstationName
                                         val workstationName = getWorkstationDisplayName(lookupKey, rawWorkstationName)
